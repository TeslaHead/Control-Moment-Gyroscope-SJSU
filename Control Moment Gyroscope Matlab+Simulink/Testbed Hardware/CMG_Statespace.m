...
h1 = - 0.00215346;      % flywheel angular momentum 1 [kg*m^2/s]
h2 = - 0.00215346;      % flywheel angular momentum 2 [kg*m^2/s]
Iy =  0.003;      % moment of inertia about the y-axis
total_h = - (h1 + h2)/Iy;
